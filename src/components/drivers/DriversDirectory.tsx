...
import { Search, Trophy, Flag, Shield } from 'lucide-react';
...
export const DriversDirectory: React.FC<Props> = ({ drivers }) => {
    ...
    <div className="space-y-4 font-mono text-xs text-neutral-300 pb-8">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-[#242c37] pb-3">
        ...
        <span className="text-[11px] text-neutral-400">
          {filtered.length} OFFICIAL DRIVERS REGISTERED
        </span>
      </div>
        ...
        <div className="border border-[#2e3744] bg-[#14181f] p-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-base font-black text-white">
                  {selectedDriver.fullName} (#{selectedDriver.number})
                </h3>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
            <div className="border border-[#222933] bg-[#0f1216] p-2.5">
              ...
              <div className="text-lg font-black text-white timing-cell">P{selectedDriver.championshipPosition}</div>
            </div>
            <div className="border border-[#222933] bg-[#0f1216] p-2.5">
              <span className="text-[10px] text-neutral-400 uppercase">SEASON POINTS</span>
              <div className="text-lg font-black text-white timing-cell">{selectedDriver.points} PTS</div>
            </div>
            <div className="border border-[#222933] bg-[#0f1216] p-2.5">
              <span className="text-[10px] text-neutral-400 uppercase">GRAND PRIX WINS</span>
              <div className="text-lg font-black text-amber-400 timing-cell">{selectedDriver.wins} WINS</div>
            </div>
            <div className="border border-[#222933] bg-[#0f1216] p-2.5">
      ...
      <ProvenanceBadge
        provenance={{
          provider: 'Jolpica F1',
          sourceUrl: 'https://api.jolpi.ca/ergast/f1/current/drivers.json',
          retrievedAt: new Date().toISOString(),
          isLive: false,
          isFixture: false,
          notes: 'Official FIA Formula 1 Driver Registry'
        }}
      />
    </div>
  );
